...
export const GET = withApi(async (request) => {
  try {
    ...
    log.error({ err: error instanceof Error ? error.message : String(error) }, "Error fetching rider surveys");
    return NextResponse.json(
...
export const POST = withApi(async (request) => {
  try {
    ...
    log.error({ err: error instanceof Error ? error.message : String(error) }, "Error creating rider survey");
    return NextResponse.json(
