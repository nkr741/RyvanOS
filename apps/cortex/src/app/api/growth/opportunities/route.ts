...
const log = createLogger("api:growth:opportunities");
...
export const GET = withApi(async (request) => {
  try {
    ...
    log.error({ err: error instanceof Error ? error.message : String(error) }, "Growth opportunities GET error");
...
export const POST = withApi(async (request) => {
  try {
    ...
    log.error({ err: error instanceof Error ? error.message : String(error) }, "Growth opportunities POST error");
